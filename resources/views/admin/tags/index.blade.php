                ...
                <tbody>
                    @foreach($tags as $tag)
                        <tr>
                            ...
                            <td>{{ $tag->title }}</td>
                            <td class="text-center"><a href="{{ route('admin.tags.show', $tag->id) }}"><i class="fa-solid fa-eye"></i></a></td>
                            <td class="text-center"><a href="{{ route('admin.tags.edit', $tag->id) }}" class="text-success"><i class="fa-solid fa-pen-to-square"></i></a></td>
