...
<div class="app-content-header">
    ...
    <!--begin::Row-->
    <div class="row">
        <div class="col-sm-6"><h3 class="mb-0">Список пользователей</h3></div>
        <div class="col-sm-6">
                ...
                <tbody>
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->name }}</td>
                            <td class="text-center"><a href="{{ route('admin.users.show', $user->id) }}"><i class="fa-solid fa-eye"></i></a></td>
                            <td class="text-center"><a href="{{ route('admin.users.edit', $user->id) }}" class="text-success"><i class="fa-solid fa-pen-to-square"></i></a></td>
